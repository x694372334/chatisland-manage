    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="orderList">
          <el-table-column label="订单编号" align="center" key="chatterId" prop="chatterId"/>
          <el-table-column label="用户编号" align="center" key="orderId" prop="orderId"/>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {key: 3, label: `道具SKU`, visible: true},
        {key: 4, label: `道具类型`, visible: true},
        {key: 5, label: `订单价格`, visible: true},
        {key: 6, label: `支付方式`, visible: true},
        {key: 7, label: `订单状态`, visible: true},
        {key: 8, label: `充值来源`, visible: true},
        {key: 9, label: `支付时间`, visible: true},
        {key: 10, label: `关联chatter`, visible: true}
      ],
    };
  },
  created() {
