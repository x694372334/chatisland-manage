...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="chatterID" align="center" prop="userId" v-if="true"/>
      <el-table-column label="chatter账号" align="center" prop="userName"/>
      <el-table-column label="chatter昵称" align="center" prop="nickName"/>
      <el-table-column label="chatter聊天总数" align="center" prop="chatCount"/>
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button icon="el-icon-position"
                     size="small"
                     type="text"
                     @click="showChatisland(scope.row,scope.index)">选择聊天记录
          </el-button>
