...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户聊天总数" align="center" prop="chatCount"/>
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button icon="el-icon-position"
                     size="small"
                     type="text"
                     @click="showChatisland(scope.row,scope.index)">选择人设
          </el-button>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true;
      selectChatHistoryFromUser(this.queryParams).then(response => {
